...
export const mn = {
  ...
  hero: {
    ...
    primaryCta: "Messenger-ээр зөвлөгөө авах",
    secondaryCta: "Төслүүд үзэх",

    meta: {
      status: "Шинэ төсөл дээр ажиллахад бэлэн",
      focus: "Вэбсайт & Бизнесийн систем",
      location: "Улаанбаатар",
    },

    techLine: "24 цагийн дотор хариулна · JP / MN / EN",
  ...
  baDemo: {
    ...
    title: "Одоогийн өдрүүд — ба цаашдын өдрүүд.",
    description:
      "Зүүн талд — ердийн ажлын өдөр. Баруун талд — систем нэвтрүүлсний дараах яг тэр өдөр. Голын зураасыг чирвэл санаа зовоосон зүйл бүр хэрхэн өөрчлөгдөхийг шууд харьцуулж болно.",
    now: "Одоо",
    future: "Цаашид",
    hint: "чирж үзээрэй",
  },
  ...
  homeOverview: {
    ...
    servicesTitle: "Сонгогдох вэбсайт, ажлыг хөнгөвчлөх систем.",
    servicesDescription:
      "Нэг хуудас танилцуулгаас эхлээд олон хэлт захиалгын сайт, дотоод систем хүртэл. Хэрэгтэй хэмжээгээр нь тодорхой үнэ, хугацаатай бүтээнэ.",
    servicesLink: "Үйлчилгээ ба үнийг үзэх",
    ...
    contactDescription:
      "Юу хийхээ бүрэн шийдээгүй байсан ч болно. Messenger-ээр товч бичээрэй, 24 цагийн дотор өөрөө хариулна.",
    contactLink: "Холбоо барих хуудсыг нээх",
    messengerLink: "Messenger-ээр үнэгүй зөвлөгөө авах",
  },
  ...
  projects: {
    ...
    items: {
      ...
      "odootech-website": {
        title: "OdooTech албан ёсны сайт",
        description:
          "10 жилийн нэвтрүүлэлтийн туршлага, eBarimt·банкны интеграцийн давуу талыг нэг дороос харуулах корпорат сайт.",
        tags: ["Итгэл төрүүлэх төрх", "Static export — агшин зуур нээгдэнэ", "Үйлчилгээнээс интеграци хүртэл"],
        client: "OdooTech LLC",
        summary:
          "Монголд 10+ жил Odoo ERP нэвтрүүлж буй OdooTech LLC-ийн албан ёсны сайтыг Next.js дээр эхнээс нь бүтээсэн. 200+ төсөл, eBarimt, 5 банк, төлбөрийн интеграци зэрэг давуу талуудыг бизнес эзэн төөрөхгүй уншиж ойлгох нэг story болгон цэгцэлсэн.",
        scope:
          "Мэдээллийн архитектур, өөрийн дизайн систем, Next.js implementation, бүрэн static export, deploy хүртэл хариуцсан.",
        focus:
          "ERP шиг тайлбарлахад хэцүү бүтээгдэхүүнийг, хайж орж ирсэн бизнес эзэн хэдхэн секундэд «энд итгэж болно» гэж мэдрэх бүтэцтэй болгох. Тоо баримт (200+ төсөл · 10 жил) болон бодит интеграцийн түншүүдийг түрүүнд гаргасан.",
        behind:
          "Enterprise мэдрэмжийг гаргахын тулд дизайн системийг зарчмаас нь өөрсдөө босгож, фонтоо subset хийж, бүрэн static export-оор ямар ч сүлжээнд агшин зуур нээгддэг болгосон.",
      },
      futari: {
        title: "Futari",
        description:
  ...
  services: {
    title: "Сонгогдох вэбсайт,\nажлыг хөнгөвчлөх систем.",
    intro: [
      "Жижиг бизнес, аялал жуулчлалын компанид зориулсан вэбсайт, онлайн захиалга болон дотоод системийг дизайн, хөгжүүлэлт, нээлт хүртэл нэг дор бүтээнэ.",
      "Багц бүрийн үнэ, хугацаа, багтах ажлыг доор тодорхой харуулав.",
    ],
    ctaLabel: "Messenger-ээр зөвлөгөө авах",
    labels: {
      before: "Одоо",
      after: "Дараа нь",
    ...
    pillars: [
      ...
      },
      {
        ...
        price: "₮8 саяас",
        timeline: "6 долоо хоногоос",
      },
    ],
    packages: {
      eyebrow: "ҮЙЛЧИЛГЭЭНИЙ БАГЦ",
      title: "Хэмжээ, үнэ, хугацаа нь эхнээсээ ойлгомжтой.",
      description:
        "Доорх үнэ нь эхлэх баримжаа. Агуулга, хэлний тоо, нэмэлт функцээс хамаарч эцсийн саналыг зөвлөгөөний дараа баталгаажуулна.",
      recommendedLabel: "Ихэнх бизнест тохиромжтой",
      items: [
        {
          name: "Launch Website",
          description:
            "Үйлчилгээ, байршил, үнэ болон холбоо барих мэдээллээ нэг хуудсаар ойлгомжтой хүргэх жижиг бизнесийн сайт.",
          price: "₮1.5–2.5 сая",
          timeline: "1–2 долоо хоног",
          features: [
            "1 хуудас, 1 хэл",
            "Custom дизайн ба mobile хувилбар",
            "Холбоо барих форм эсвэл Messenger",
            "Domain холбоход дэмжлэг",
            "Basic SEO ба Analytics",
          ],
        },
        {
          name: "Business Website",
          description:
            "Олон үйлчилгээ, олон хэл, захиалгын урсгал хэрэгтэй өсөж буй бизнесийн үндсэн сайт.",
          price: "₮3–6 сая",
          timeline: "3–5 долоо хоног",
          recommended: true,
          features: [
            "5–8 хуудас",
            "2–3 хэлний хувилбар",
            "Захиалга эсвэл хүсэлт авах урсгал",
            "Энгийн CMS / контент шинэчлэлт",
            "SEO, Analytics, launch support",
          ],
        },
        {
          name: "Business System / App",
          description:
            "Бүртгэл, захиалга, ажилтан, тайлан зэрэг өдөр тутмын ажиллагааг нэг дор удирдах custom систем.",
          price: "₮8 саяас",
          timeline: "6 долоо хоногоос",
          features: [
            "Шаардлага ба ажлын урсгалын зураглал",
            "Login, эрхийн түвшин, admin дэлгэц",
            "Database ба API integration",
            "Web app эсвэл mobile app",
            "Тест, нээлт, ашиглалтын заавар",
          ],
        },
      ],
    },
    care: {
      ...
      description:
        "Нээгээд л орхихгүй. Сар бүр тогтсон цагаар жижиг засвар, контент шинэчлэлт, техникийн шалгалтыг хариуцна.",
      price: "₮250k–500k / сар",
      details: [
        "Сард 2–5 цагийн жижиг засвар",
        "Текст, зураг, мэдээлэл шинэчлэх",
        "Алдаа болон ажиллагааны шалгалт",
        "Нэмэлт хөгжүүлэлтийг тусад нь үнэлнэ",
      ],
    },
    process: {
  ...
  contact: {
    ...
    primaryTitle: "Эхлээд мессежээр зөвлөлдөх",
    primaryDescription:
    ...
    form: {
      ...
      messageLabel: "Мессеж",
      messagePlaceholder:
        "Жишээ: Захиалгыг утсаар авах нь төвөгтэй болсон тул онлайнаар авмаар байна. Төсөв ₮3–5 сая орчим.",
      ...
      note: "Юу ч шийдээгүй байсан ч　зүгээр. Хамтдаа зөвлөлдий.",
      close: "Хаах",
    },
  },

  footer: {
    title: "Zaya — Вэб ба систем хөгжүүлэлт",
