...
export const mn = {
  ...
  projects: {
    ...
    titleB: "Төслүүд",
    description:
      "Дизайнаас эхлээд deploy хүртэл ганцаараа хариуцаж, хэрэглэхэд хялбар, харахад гоё бүтээгдэхүүн хийдэг.",
    ...
    items: {
      "workout-log": {
        ...
        scope:
          "Дизайн, frontend, backend, DB загвар, deploy хүртэл бүгдийг ганцаараа хийсэн.",
        focus:
          "Бичлэг хийхэд хялбар байдал, долоо хоногийн графикийн уншигдах байдал — үргэлжлүүлэхийг хүсэх UI.",
      },
      "soul-skin-brand-lookbook": {
        ...
        focus:
          "Брэндийн уур амьсгалыг visual-аар дамжуулах, SNS болон холбоо барих хуудас руу чиглүүлэх байгалийн урсгал.",
      },
    },
