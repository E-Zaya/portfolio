...
export const ja = {
  ...
  about: {
    ...
    title: "多言語対応のWeb開発者",
    paragraphs: [
      "モンゴル語・日本語・英語に対応できるWeb開発者として、言語や文化の違いを越えて、伝わりやすく使いやすいWebサイトを制作しています。",
      "日本で10年間を過ごした後、本気でエンジニアを目指すためモンゴルへ帰国。現在はIO Instituteでフルスタック開発を集中的に学びながら、個人事業主・小規模店舗向けのWebサイト制作にも取り組んでいます。",
      "言語だけでなく、伝える相手や目的まで考えた設計で、見る人に届くWebサイトを目指しています。",
    ],
      strengthsEyebrow: "強み",
  ...
  services: {
    ...
    plans: {
      simple: {
        ...
        description: "1ページでサービスや店舗の魅力を伝える、シンプルなLPプラン。",
        details: [
          "1ページ構成（LP）",
          "オリジナルデザイン",
          "SNSリンク",
