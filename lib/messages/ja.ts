...
export const ja = {
  ...
  meta: {
    ...
    pages: {
      ...
      privacy: {
        title: "プライバシーポリシー",
        description:
          "当サイトにおける個人情報の取り扱い(お問い合わせフォーム・アクセス解析)について説明します。",
      },
      blog: {
        title: "ブログ — Web制作の記録",
        description:
  ...
  baDemo: {
    ...
    title: "いまの毎日と、これからの毎日。",
    description:
      "左が、よくある毎日。右が、仕組みを入れたあとの毎日。真ん中の仕切りを動かすと、同じ悩みがどう変わるか、その場で見比べられます。",
    now: "今",
    future: "これから",
    hint: "引っぱってみて",
  },
  ...
  projects: {
    ...
    items: {
      ...
      "odootech-website": {
        title: "OdooTech 公式サイト",
        description:
          "10年の導入実績とeBarimt・銀行連携の強みを、一目で伝えるコーポレートサイト。",
        tags: ["企業の信頼が伝わる顔", "静的書き出しで一瞬表示", "導入から連携まで一望"],
        client: "OdooTech LLC",
        summary:
          "モンゴルでOdoo ERPを10年以上展開するOdooTech LLCの公式サイトを、Next.jsでゼロから構築。200+の導入実績、eBarimt・5銀行・決済とのインテグレーションといった強みを、経営者が迷わず読み進められる1本のストーリーに整理しました。",
        scope:
          "情報設計、独自デザインシステムの構築、Next.js実装、完全静的書き出し、デプロイまで担当。",
        focus:
          "ERPという難しい商材を、検索してきた経営者が数秒で「ここは任せられる」と感じられる構成に。数字(200+導入・10年)と実際の連携先を前面に出し、信頼を積み上げる情報設計にしました。",
        behind:
          "エンタープライズらしさを出すため設計思想から独自のデザインシステムを組み、フォントのサブセット化と完全静的書き出しで、どの回線でも一瞬で開く速さに仕上げました。",
      },
      futari: {
        title: "Futari",
        description:
