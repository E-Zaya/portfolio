...
export const ja: typeof en = {
  ...
  services: {
    ...
    plans: {
      simple: {
        name: "Simple LP",
        price: "¥40,000〜¥50,000（税込）",
        description: "最小構成。とにかく早く・シンプルに始めたい方向けのLP。",
        details: [
          "1ページ構成（LP）",
          "オリジナルデザイン",
          "SNSリンク",
        ...
        timeline: "最短7〜14日",
        note: "初期実績価格として、先着5件のみこの価格で対応しています。",
      },
      starter: {
        name: "Starter Website",
        badge: "おすすめ",
        price: "¥80,000〜¥98,000（税込）",
        ...
        timeline: "3〜4週間",
        note: "事業内容・実績・お問い合わせまで一通り整えた、実用的なWebサイト。お客様自身でお知らせを更新できるから、更新作業もラクチン。",
      },
      custom: {
        ...
        note: "要件に応じて設計・開発。機能ベースで柔軟に構築します。ログイン機能、決済、データベース連携など、本格的なWebアプリもお任せください。",
      },
    },
    targetAudience: {
      title: "こんな方におすすめ",
